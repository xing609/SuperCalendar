...
public class CalendarView extends FrameLayout {
    ...
    public void setLeftScollble(boolean scoll){
        if (mWeekPager.getVisibility() == VISIBLE) {
            mWeekPager.setLeftScrollble(scoll);
        }
     ...
     * @param pageListener
     */
    public void pageScrollListener(final PageListener pageListener){
        WeekViewPager.pageScrollListener(new PageListener() {
            @Override
            public void onPageSelected() {
                pageListener.onPageSelected();
            }
        });
    }
    ...
    public boolean getCanScroll(){
        return mWeekPager.getCanScroll();
    }
    ...
    public void setRange(int minYear, int minYearMonth, int maxYear, int maxYearMonth) {
        ...
        if (Util.isCalendarInRange(mDelegate.mSelectedCalendar, mDelegate)) {
            scrollToCalendar(mDelegate.mSelectedCalendar.getYear(), mDelegate.mSelectedCalendar.getMonth(), mDelegate.mSelectedCalendar.getDay());
...
//    public void scrollToNextMonth(boolean smoothScroll) {
//            mMonthPager.setCurrentItem(mMonthPager.getCurrentItem() + 1, smoothScroll);
//    }
...
//
//    public void scrollToPreMonth(boolean smoothScroll) {
//        mMonthPager.setCurrentItem(mMonthPager.getCurrentItem() - 1, smoothScroll);
//    }
